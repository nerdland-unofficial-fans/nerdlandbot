    ...
    for guild_data in guilds_data:
        ...
        for church in guild_data.church_event:
            ...
            for _ in range(len(guild_data.church_event)):
                if day == church["day"] and hour == 16:
                    msg = translate("church", church["culture"]).format(church_emoji, church["receiver"], church["sender"], fist)
                    if church["message"]:
                        msg += translate("church_message", church["culture"]).format(church["message"])
